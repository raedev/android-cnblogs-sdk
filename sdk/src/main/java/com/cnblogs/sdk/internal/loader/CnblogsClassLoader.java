 ...
 */
public final class CnblogsClassLoader {
    ...
    public CnblogsClassLoader(Context context) {
        mContext = context;
    }
    ...
    private String getPatchPath() {
        ...
        FileUtils.createOrExistsDir(patchDir);
    ...
    private ClassLoader newClassLoader() {
        ...
        loader = new PatchClassLoader(patchPath, optimizedDir, loader);
        return loader;
    }
    ...
    @Nullable
    public <T> T newInstance(Class<T> cls, Application context) {
        ClassLoader loader = getClassLoader();
        try {
            Class<?> iClass = loader.loadClass(cls.getName());
            Constructor<?> constructor = iClass.getDeclaredConstructor(Application.class);
    ...
    public <T> T newInstance(Class<T> cls) {
        ...
        try {
            Class<?> iClass = loader.loadClass(cls.getName());
            Constructor<?> constructor = iClass.getDeclaredConstructor();
            constructor.setAccessible(true);
    ...
    public boolean apply() {
        ...
        try {
            ...
            ClassLoader loader = new PatchClassLoader(downloadFile.getPath(), null, null);
